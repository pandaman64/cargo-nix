  ...
  internal = rec {
    ...
    crates = {
      ...
      "owo-colors" = rec {
        ...
        version = "1.2.1";
        edition = "2018";
        sha256 = "0yxaqcfigw9msr82syimn16419nwyjs916xn3dq2jhj78jp0sdqk";
        authors = [
      ...
      "ureq" = rec {
        ...
        version = "2.0.1";
        edition = "2018";
        sha256 = "1g144d7jhb29zj7lzz8h91scmk5c32fr0kzfv9vjd0l5iknls0cn";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "wtypesbase" ];
      };
